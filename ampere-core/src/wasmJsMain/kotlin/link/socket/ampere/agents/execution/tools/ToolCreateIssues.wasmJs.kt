...
actual suspend fun executeCreateIssues(
    ...
    // Browser JS does not support GitHub CLI operations
    ...
    return ExecutionOutcome.IssueManagement.Failure(
        ...
        error = ExecutionError(
            ...
            message = "Issue creation is not supported in browser environments",
            details = "GitHub CLI operations require shell access which is not available in JavaScript",
            isRetryable = false,
        ),
